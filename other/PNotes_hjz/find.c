...
static void ApplyFindLanguage(HWND hwnd){
	...
	SetDlgCtlText(hwnd, IDC_CMD_FIND_NEXT, szFile, L"Find Next");
	...
	SetDlgCtlText(hwnd, IDC_CMD_REPLACE, szFile, L"Replace");
	SetDlgCtlText(hwnd, IDC_OPT_FIND_UP, szFile, L"Up");
	SetDlgCtlText(hwnd, IDC_OPT_FIND_DOWN, szFile, L"Down");
}
