...
strFrame+='         onmouseover="style.color=\'#ff0000\'" onmouseout="style.color=\'#1478eb\'" title="當前日期時間">当前</span>&nbsp;&nbsp;<span style="cursor:hand" id=evaAllOK onmouseover="style.color=\'#ff0000\'" onmouseout="style.color=\'#1478eb\'"  onclick="parent.closeLayer()" title="关闭日历">关闭&nbsp;</span></td></tr>';
...
function tmpSelectSecondInnerHTML(strSecond) //秒的下拉框
{
 ...
 if (strSecond.match(/\D/)!=null){alert("秒鐘輸入參數不是數字！");return;}
